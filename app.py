...
# Streamlit UI
st.set_page_config(page_title="DocsInSights", page_icon=":book:", layout="wide")
...
with st.sidebar:
    ...
    with st.expander("Instructions - How to Use DocsInSights"):
        st.markdown(f"""
...
#     <h1 style="color: black; font-weight: bold; font-size: 40px; margin-bottom: -22px;">DocsInSights</h1>
...
with col2:
    ...
    <div style="margin-top: -38px;">
        <h1 style="color: black; font-weight: bold; font-size: 43px; margin-bottom: -24px;">DocsInSights</h1>
